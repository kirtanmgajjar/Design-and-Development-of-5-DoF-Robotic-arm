...
d5=[s(1,4);s(2,4);s(3,4)];

j1=[cross(r0*[0;0;1],d5-d0);r0*[0;0;1]];
j2=[cross(r1*[0;0;1],d5-d1);r1*[0;0;1]];
j3=[cross(r2*[0;0;1],d5-d2);r2*[0;0;1]];
j4=[cross(r3*[0;0;1],d5-d3);r3*[0;0;1]];
j5=[cross(r4*[0;0;1],d5-d4);r4*[0;0;1]];
