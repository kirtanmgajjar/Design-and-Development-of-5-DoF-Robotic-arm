tr=input("Enter Transformation Matrix: ");
l=0.5;
b=tr(1:3,1:3);
d4=b*[132.39;0;0];
o = tr(1:3,4)-d4;
...
fprintf('Value of theta 1: %0.2f\n',t(1))
fprintf('Value of theta 2: %0.2f\n',t(2))
fprintf('Value of theta 3: %0.2f\n',t(3))
fprintf('Value of theta 4: %0.2f\n',t(4))
fprintf('Value of theta 5: %0.2f\n',t(5))